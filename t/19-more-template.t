...
$html = '<div><div><ul class="pagination"><li><a href="#" id="tc<" class="tc-normal" onclick="paginationaboveTc.prev();"><</a></li><li><a href="#" id="tc1" class="tc-selected" onclick="paginationaboveTc.showPage(1)">1</a></li><li><a href="#" id="tc2" class="tc-normal" onclick="paginationaboveTc.showPage(2);">2</a></li><li><a href="#" id="tc3" class="tc-normal" onclick="paginationaboveTc.showPage(3);">3</a></li><li><a href="#" id="tc>" class="tc-normal" onclick="paginationaboveTc.next();">></a></li></ul></div><table id="paginationaboveTable"><caption class="some-class" id="caption-id">table caption</caption><tr><th class="some-class" id="something-id">Id</th><th class="okay">Name</th><th class="what">Address</th></tr><tr><td>1</td><td>rob</td><td>somewhere</td></tr><tr><td>2</td><td>sam</td><td>somewhere else</td></tr><tr><td>3</td><td>frank</td><td>out</td></tr><tr><td>4</td><td>rob</td><td>somewhere</td></tr><tr><td>5</td><td>sam</td><td>somewhere else</td></tr><tr style="display:none;"><td>6</td><td>frank</td><td>out</td></tr><tr style="display:none;"><td>7</td><td>rob</td><td>somewhere</td></tr><tr style="display:none;"><td>8</td><td>sam</td><td>somewhere else</td></tr><tr style="display:none;"><td>9</td><td>frank</td><td>out</td></tr><tr style="display:none;"><td>10</td><td>rob</td><td>somewhere</td></tr><tr style="display:none;"><td>11</td><td>sam</td><td>somewhere else</td></tr><tr style="display:none;"><td>12</td><td>frank</td><td>out</td></tr></table><script type="text/javascript">var paginationaboveTc = new HtmlTC("paginationaboveTable", 5, 3);</script></div>';

is($template->render, $html, "okay html - $html");

ok($template = t::Templates::Sort->new());

$html = '<table id="sortTable"><caption class="some-class" id="caption-id">table caption</caption><tr><th class="some-class" id="something-id" onclick="sortTc.sortData(this, 0, \'desc\')">Id<i>&#9658;</i></th><th class="okay" onclick="sortTc.sortData(this, 1, \'desc\')">Name<i>&#9658;</i></th><th class="what" onclick="sortTc.sortData(this, 2, \'desc\')">Address<i>&#9658;</i></th></tr><tr><td>1</td><td>rob</td><td>somewhere</td></tr><tr><td>2</td><td>sam</td><td>somewhere else</td></tr><tr><td>3</td><td>frank</td><td>out</td></tr></table><script type="text/javascript">var sortTc = new HtmlTC("sortTable", 3, 1);</script>';
